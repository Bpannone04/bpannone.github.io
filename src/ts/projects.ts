...
export interface Project {
  title: string;
  description: string;
  /** Shown in the modal when the card is clicked. If omitted, the card description is used. */
  detail?: string;
  tags: string[];
  link?: string;
  gallery?: string[];
...
export const projects: Project[] = [
  {
    ...
    detail:
      "The problem I aimed to solve was the ease of checking in at the gym, signing up for classes, and managing the gym. I found a lack of comprehensive software that covered all of these aspects, which led me to develop this program.\n\n" +
  ...
  },
  {
    ...
    detail:
      "I built this website mainly because I wanted to learn TypeScript and use Tailwind. After some thought, I also needed a personal website to accompany my resume, so working on this project made sense.\n\n" +
